...
class SceGoogleApiHandler {
  ...
  constructor(scopes, tokenPath) {
    ...
    this.CLIENT_ID = apiConfigs.client_id;
    this.CLIENT_SECRET = apiConfigs.client_secret;
    this.REDIRECT_URIS = apiConfigs.redirect_uris;
    this.USER = apiConfigs.user;
    this.REFRESH_TOKEN = apiConfigs.refresh_token;
    console.log([
      this.CLIENT_ID,
this.CLIENT_SECRET,
this.REDIRECT_URIS[0]
    ...
    console.log({wtf: this.REFRESH_TOKEN})
